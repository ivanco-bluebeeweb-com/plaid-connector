...
def _connect_section() -> ui.UINode:
    ...
    return ui.Stack(direction="v", gap=3, align="stretch", children=[
        ...
        ui.Button("Connect Bank via Plaid Link (OAuth)", variant="primary", size="sm", icon="login"),
        ui.Divider(),
        ui.Text("Or connect via Client ID & Secrets", variant="caption"),
        ui.Form(
...
async def plaid_connect_panel(ctx, **kwargs) -> object:
    ...
    return ui.Stack(direction="v", gap=4, align="stretch", children=[
        ...
        ui.Divider(),
        ui.Button("View account overview", variant="primary", size="sm", icon="Landmark", on_click=ui.Call("__panel__plaid_center")),
        ui.Divider(),
        _connect_section(),
        ui.Divider(),
        _settings_button(),
